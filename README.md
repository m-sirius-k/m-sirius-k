...
It runs a verification routine that confirms the MoCKA ecosystem is structurally valid and ready for reproducible research.
...
One-command demo (command and expected output)
...
このデモは Research Gate 検証システムが何を行い、何を証明するのかを示します。
